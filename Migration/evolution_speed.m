function [ensemble, m_v_t, se_v_t] = evolution_speed(varargin)
...
for j = 1:num_cells-1
    ...
    ensemble(j,strt_frame+1:end_frame) = cell(j).step_s;
end
% temp = ensemble(:,frame_range(1): frame_range(2));
% ensemble = temp;
% =========================================================================
